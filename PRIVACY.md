...
- **Models are downloaded once.** On first run the selected STT model is fetched from Hugging Face; everything after that is local. If you need a machine that never reaches the network, pre-populate `models/` and run offline.
