...
def test_owner_is_written_one_way_in_the_assignments_section():
    ...
    assert out.split("\n")[1:11] == [
        "- [ ] **Марк** — смета", "- [x] **Марк** — регистр",
        "- [ ] **Ковалёву** — фамилия в падеже", "- [ ] **Ковалев** — фамилия без ё",
    ...
    # формы выводятся из ИМЕНИ владельца: дательный по типу склонения, беглая гласная, ё/е
