...
def test_ключ_встречи_целиком_и_ничего_больше():
    """`is_stamp` — один ответ на «такая встреча может существовать» для выдачи
    по штампу и для манифеста архива (Critical DeepSeek по PR #635): строка,
    которая не штамп, встречу не называет, а не-строка — тем более."""
    for ключ in ("2026-07-21_0930", "2026-07-21_093015", "2026-07-21_093015-2", "2026-07-21_0930-1"):
        assert meeting_stamp.is_stamp(ключ), ключ
    for не_ключ in ("заметки", "", "2026-07-21", "2026-07-21_09301", "2026-07-21_0930_Тема",
                    " 2026-07-21_0930", "2026-07-21_0930\n", 42, None):
        assert not meeting_stamp.is_stamp(не_ключ), repr(не_ключ)
