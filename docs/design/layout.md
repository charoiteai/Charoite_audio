...
- `scripts/layout_map.py` ← ручной запуск: генератор раскладки — этот файл; зовут pytest (tests исключены из области) и человек
...
- `src/diarize.py` ← ручной запуск: диаризация записи вручную для замеров (README «Диаризация»)
...
- `scripts/check_private_markers.py` ← CONTRIBUTING.md, MAINTENANCE.md, docs/reviews/2026-07-30-критерии.md, docs/ru/CONTRIBUTING.md, docs/ru/MAINTENANCE.md, docs/zh/CONTRIBUTING.md, docs/zh/MAINTENANCE.md
...
- `scripts/doctor.py` ← README.md, docs/ARCHITECTURE.md, docs/DATA_AND_RECOVERY.md, docs/SETUP.md, docs/USER_GUIDE.md, docs/reviews/2026-07-30-критерии.md, docs/ru/ARCHITECTURE.md, docs/ru/DATA_AND_RECOVERY.md, docs/ru/README.md, docs/ru/SETUP.md, docs/ru/USER_GUIDE.md, docs/zh/ARCHITECTURE.md, docs/zh/DATA_AND_RECOVERY.md, docs/zh/README.md, docs/zh/SETUP.md, docs/zh/USER_GUIDE.md, pyproject.toml
- `scripts/fix_action_items.py` ← docs/FEATURES.md, docs/ru/FEATURES.md, docs/zh/FEATURES.md
- `scripts/forget_meeting.py` ← CHANGELOG.md, PRIVACY.md, docs/DATA_AND_RECOVERY.md, docs/FEATURES.md, docs/reviews/2026-07-30-чего-не-хватает.md, docs/ru/DATA_AND_RECOVERY.md, docs/ru/FEATURES.md, docs/ru/PRIVACY.md, docs/zh/DATA_AND_RECOVERY.md, docs/zh/FEATURES.md, docs/zh/PRIVACY.md
- `scripts/get_models.py` ← PRIVACY.md, README.md, ROADMAP.md, SECURITY.md, config/config.example.zh.yaml, docs/DIARIZATION.md, docs/FEATURES.md, docs/MODELS.md, docs/reviews/2026-07-30-чего-не-хватает.md, docs/ru/DIARIZATION.md, docs/ru/FEATURES.md, docs/ru/MODELS.md, docs/ru/PRIVACY.md, docs/ru/README.md, docs/ru/ROADMAP.md, docs/ru/SECURITY.md, docs/zh/DIARIZATION.md, docs/zh/FEATURES.md, docs/zh/MODELS.md, docs/zh/PRIVACY.md, docs/zh/README.md, docs/zh/ROADMAP.md, docs/zh/SECURITY.md
- `scripts/graph_doctor.py` ← docs/ARCHITECTURE.md, docs/ru/ARCHITECTURE.md
- `scripts/import_meeting.py` ← PRIVACY.md, README.md, docs/DATA_AND_RECOVERY.md, docs/FEATURES.md, docs/USER_GUIDE.md, docs/reviews/2026-07-30-критерии.md, docs/ru/DATA_AND_RECOVERY.md, docs/ru/FEATURES.md, docs/ru/PRIVACY.md, docs/ru/README.md, docs/ru/USER_GUIDE.md, docs/zh/DATA_AND_RECOVERY.md, docs/zh/FEATURES.md, docs/zh/PRIVACY.md, docs/zh/README.md, docs/zh/USER_GUIDE.md
...
- `scripts/memory_bench.py` ← CONTRIBUTING.md, README.md, config/memory_bench.example.yaml, demo/README.md, docs/ARCHITECTURE.md, docs/FEATURES.md, docs/reviews/2026-07-30-критерии.md, docs/reviews/2026-07-30-чего-не-хватает.md, docs/ru/ARCHITECTURE.md, docs/ru/CONTRIBUTING.md, docs/ru/FEATURES.md, docs/ru/README.md, docs/ru/demo/README.md, docs/zh/ARCHITECTURE.md, docs/zh/CONTRIBUTING.md, docs/zh/FEATURES.md, docs/zh/README.md, docs/zh/demo/README.md
...
- `scripts/morning_brief.py` ← docs/FEATURES.md, docs/reviews/2026-07-30-критерии.md, docs/ru/FEATURES.md, docs/zh/FEATURES.md
...
- `scripts/nightly_claude_cores.py` ← docs/reviews/2026-07-30-критерии.md
- `scripts/nightly_dossier.py` ← docs/FEATURES.md, docs/ru/FEATURES.md, docs/zh/FEATURES.md
- `scripts/nightly_dossier_review.py` ← docs/FEATURES.md, docs/reviews/2026-07-30-критерии.md, docs/ru/FEATURES.md, docs/zh/FEATURES.md
...
- `scripts/stt_bench.py` ← docs/FEATURES.md, docs/MODELS.md, docs/reviews/2026-07-30-чего-не-хватает.md, docs/ru/FEATURES.md, docs/ru/MODELS.md, docs/zh/FEATURES.md, docs/zh/MODELS.md
...
- `src/audio.py` ← docs/reviews/2026-07-30-чего-не-хватает.md
...
- `src/daemon.py` ← SECURITY.md, docs/ARCHITECTURE.md, docs/SETUP.md, docs/reviews/2026-07-30-критерии.md, docs/reviews/2026-07-30-чего-не-хватает.md, docs/ru/ARCHITECTURE.md, docs/ru/SECURITY.md, docs/ru/SETUP.md, docs/zh/ARCHITECTURE.md, docs/zh/SECURITY.md, docs/zh/SETUP.md
...
- `src/graph_updater.py` ← docs/ARCHITECTURE.md, docs/reviews/2026-07-30-cloud-permissions-audit.md, docs/reviews/2026-07-30-критерии.md, docs/ru/ARCHITECTURE.md, docs/zh/ARCHITECTURE.md
- `src/live_gate.py` ← docs/ARCHITECTURE.md, docs/ru/ARCHITECTURE.md, docs/zh/ARCHITECTURE.md
- `src/llm.py` ← config/config.example.yaml, docs/FEATURES.md, docs/ru/FEATURES.md, docs/zh/FEATURES.md
- `src/main.py` ← README.md, docs/SETUP.md, docs/reviews/2026-07-30-критерии.md, docs/ru/README.md, docs/ru/SETUP.md, docs/zh/README.md, docs/zh/SETUP.md
- `src/mcp_server.py` ← docs/ARCHITECTURE.md, docs/reviews/2026-07-30-критерии.md, docs/ru/ARCHITECTURE.md, docs/zh/ARCHITECTURE.md
- `src/meeting_archive.py` ← docs/ARCHITECTURE.md, docs/ru/ARCHITECTURE.md, docs/zh/ARCHITECTURE.md
- `src/nli.py` ← docs/ARCHITECTURE.md, docs/ru/ARCHITECTURE.md, docs/zh/ARCHITECTURE.md, docs/zh/FEATURES.md, pyproject.toml
- `src/privacy.py` ← CHANGELOG.md, MANIFESTO.md, PRIVACY.md, SECURITY.md, docs/ARCHITECTURE.md, docs/FEATURES.md, docs/reviews/2026-07-30-критерии.md, docs/ru/ARCHITECTURE.md, docs/ru/FEATURES.md, docs/ru/MANIFESTO.md, docs/ru/PRIVACY.md, docs/ru/SECURITY.md, docs/zh/FEATURES.md, docs/zh/MANIFESTO.md, docs/zh/PRIVACY.md, docs/zh/SECURITY.md
...
- `src/retro_fill.py` ← docs/reviews/2026-07-30-чего-не-хватает.md
- `src/speaker_names.py` ← docs/FEATURES.md, docs/ru/FEATURES.md, docs/zh/FEATURES.md
- `src/stt.py` ← docs/reviews/2026-07-30-чего-не-хватает.md
- `src/stt_runtime.py` ← CONTRIBUTING.md, docs/ru/CONTRIBUTING.md
- `src/tier3.py` ← config/config.example.en.yaml, config/config.example.yaml, docs/FEATURES.md, docs/reviews/2026-07-30-чего-не-хватает.md, docs/ru/FEATURES.md, docs/zh/FEATURES.md
