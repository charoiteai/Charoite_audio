...
|----|----|----|----|----|
| **8 ГБ** | `qwen3.5:4b` (3,2 ГБ) | та же | да | Одна модель на обе роли; дежавю выключено — `bge-m3` рядом не помещается |
| **16 ГБ** | `gemma4:12b` (7,0 ГБ) | `qwen3.5:4b` | да | Все цитаты на месте (100%), кэш живой нити работает |
