...
every draft write passes through the same normalization, and a heading is
recognized structurally — an unindented line that is not a bullet — rather
than by a trailing colon on a short line.
