...
///    Выключен 07.08, код снят 02.09; уборка сирот-агрегатов
///    (`TapOrphanCleanup`) снята 06.09 (№154) — допущение, что известные
///    установки прошли через 0.69–0.72, где она жила; отставший с ≤0.68
///    сироту `ai.charoite.systemaudio.*` убирает руками (Audio MIDI Setup)
///    или перезагрузкой. Полный код тапа с граблями —
