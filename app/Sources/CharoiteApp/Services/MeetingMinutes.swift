...
struct MeetingMinutes: Equatable {
    ...
    private static let headings: [(names: [String], section: Section)] = [
        (["темы", "о чём говорили", "о чем говорили", "topics"], .topics),
        (["решения", "решили", "decisions"], .decisions),
        (["поручения", "задачи", "action items"], .tasks),
        (["открытые вопросы", "вопросы", "open questions"], .openQuestions),
        (["риски", "risks"], .risks),
        (["участники", "дата/время", "participants"], .ignored),
    ]
