...
struct SuflerView: View {
    ...
    /// подсказка живёт КАРТОЧКОЙ над нитью минимум hintCardLifetime (гаснет
    /// обновлением нити лишь отгорев своё), а нить видна всегда, пока в ней есть текст, — и во время
            ...
            ScrollViewReader { proxy in
                ScrollView {
                    VStack(alignment: .leading, spacing: 0) {
                        ...
                        // гаснет нитью только отгорев hintCardLifetime, ручной ответ —
